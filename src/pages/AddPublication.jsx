...
export default function AddPublication() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-indigo-950 to-purple-950 flex justify-center items-start px-6 py-12">
      <div className="w-full max-w-3xl bg-white/10 backdrop-blur-xl border border-white/10 rounded-2xl shadow-2xl p-8">
        ...
        <div className="mb-8">
          ...
          <p className="mt-2 text-slate-400">
            Enter publication details to be displayed on the public academic profile.
          </p>
        </div>
